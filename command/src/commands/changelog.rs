...
impl ChangelogRepo {
    ...
    pub async fn create_releases_markdown<
        'a,
        I: IntoIterator<Item = R>,
        R: Borrow<ReleaseInfo<'a>>,
...
>(
    ...
    writeln!("Generated by [`something-releaser`](https://github.com/anatawa12/something-releaser).");
    writeln!();
